            ...
            <div class="container clearfix">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-9">
                        ...
                        <img src="https://github.com/pedrogalguz05.png" class="alignleft img-circle img-thumbnail my-0" alt="Avatar"
                                ...
                                <div class="tabs tabs-alt clearfix" id="tabs-profile">
                                    ...
                                    <div class="tab-container">
                                        ...
                                        <div class="tab-content clearfix" id="tab-feeds">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium harum ea
                                                quo! Nulla fugiat earum, sed corporis amet iste non, id facilis dolorum,
                                                suscipit, deleniti ea. Nobis, temporibus magnam doloribus. Reprehenderit
                                                necessitatibus esse dolor tempora ea unde, itaque odit. Quos.</p>
                                            ...
                                            <div class="row gutter-40 posts-md mt-4">
                                                    ...
                                                    <div class="grid-inner row align-items-center g-0">
                                                        ...
                                                        <div class="col-md-8 ps-md-4">
                                                            <div class="entry-title title-sm">
                                                                <h3><a href="blog-single.html">This is a Standard post with
                                                                        a Preview Image</a></h2>
                                                            </div>
                                                            <div class="entry-meta">
                                                                <ul>
                                                                    ...
                                                                    <li><a href="#"><i class="icon-camera-retro"></i></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="entry-image">
                                                                <iframe src="https://player.vimeo.com/video/87701971"
                                                                    width="500" height="281" allow="autoplay; fullscreen"
                                                                    allowfullscreen></iframe>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-8 ps-md-4">
                                                            <div class="entry-title title-sm">
                                                                <h3><a href="blog-single-full.html">This is a Standard post
                                                                        with an Embedded Video</a></h2>
                                                            </div>
                                                            <div class="entry-meta">
                                                                <ul>
                                                ...
                                                <div class="entry col-12">
                                                    <div class="grid-inner row align-items-center g-0">
                                                        ...
                                                        <div class="col-md-8 ps-md-4">
                                                            <div class="entry-title title-sm">
                                                                <h3><a href="blog-single-small.html">This is a Standard post
                                                                        with a Slider Gallery</a></h3>
                                                            </div>
                                                            <div class="entry-meta">
                                                                <ul>
